...
public class UserResource {
    ...
    public ResponseEntity<List<User>> findAll(){
        ...
        // operação para buscar todos os usuarios do banco de dados
        // chamar no postman o caminho /users com o metodo GET
    }
    ...
    // incluindo o id após users, pega um usuário específico
